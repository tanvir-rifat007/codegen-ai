    ...
    h(
      ...
      h(
        ...
        h(
          "p",
          null,
          "Describe what you want, and our AI writes clean, production-ready code in seconds.",
        ),
      ),
      h(
        "div",
        ...
        h(
          "p",
          null,
          "Automatically deploy generated code to GitHub with our MCP-powered agent.",
        ),
      ),
      h(
        "div",
        ...
        h(
          "p",
          null,
          "Works across Go, JavaScript, Python, and more. Your stack, your rules.",
        ),
      ),
    ),
  );
  ...
  return h(
    ...
    h(
      ...
      h(
        "p",
        { className: "subtitle" },
        "Learn more about our AI-powered code generation platform",
      ),
    ),
    h(
      "section",
      ...
      h(
        ...
        h(
          "p",
          null,
          "Built with advanced AI models to understand your requirements and generate high-quality code.",
        ),
      ),
      h(
        "div",
        ...
        h(
          "p",
          null,
          "Generate production-ready code in seconds with our optimized AI pipeline.",
        ),
      ),
      h(
        "div",
        ...
        h(
          "p",
          null,
          "Built with love for the developer community. Contribute and help us improve!",
        ),
      ),
    ),
  );
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h("h1", { className: "register-title" }, "Create Account"),
            h(
              "p",
          ...
          h(
            ...
            h(
              ...
              errors.name &&
                h("div", { className: "form-error" }, "⚠️ " + errors.name),
            ),
            // Email Field
            h(
              "div",
            ...
            h(
              ...
              errors.password &&
                h("div", { className: "form-error" }, "⚠️ " + errors.password),
            ),
            // Submit Button
            h(
              "div",
          ...
          h(
            ...
            h(
              ...
              h("a", { href: "/sign-in", className: "auth-link" }, "Sign In"),
            ),
          ),
        ),
      ),
        ...
        h(
          ...
          h(
            ...
            h(
              ...
              errors.email &&
                h("div", { className: "form-error" }, `⚠️ ${errors.email}`),
            ),
            ...
            h(
              ...
              h(
                ...
                h(
                  "label",
                  { htmlFor: "rememberMe", className: "checkbox-label" },
                  "Remember me",
                ),
              ),
              h(
          ...
          h(
            ...
            h(
              "button",
              { type: "button", className: "social-btn google-btn" },
              h("span", { className: "social-icon" }, "🔍"),
              "Continue with Google",
            ),
            h(
              "button",
              { type: "button", className: "social-btn github-btn" },
              h("span", { className: "social-icon" }, "⚫"),
          ...
          h(
            ...
            h(
              ...
              h(
                "a",
                { href: "/register", className: "auth-link" },
                "Create Account",
              ),
            ),
          ),
  ...
  return h(
    ...
    h(
      ...
      h(
        "p",
        null,
        `© ${new Date().getFullYear()} Codegen AI Agent. Built for developers.`,
      ),
    ),
  );
}
